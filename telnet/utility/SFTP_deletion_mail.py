...
def send_warning_email(sftp_account_object):
    ...
    message["Subject"] = "[SFTP Account][Client] Account Deletion - " + sftp_user_name.capitalize()
                                        ...
                                        <div style="color:#66BECD;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:150%;padding-top:2px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <div style="line-height: 18px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color: #66BECD;">
                                                <p style="line-height: 36px; text-align: left; font-size: 12px; margin: 0;">
                                                    <span style="font-size: 24px;font-weight: bold;">SFTP Account Deletion - {{user_display_name}}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:0px; padding-bottom:5px; padding-right: 50px; padding-left: 50px;">
                                    ...
                                    <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 18px; color: #555555;">
                                            <p style="font-size: 12px; line-height: 24px; margin: 0;text-align: justify"><span
                                                    style="font-size: 16px;">Hi Team,<strong><br/></strong>Please be noted that the following <span
                                                    style="font-style: italic;font-weight: 600;color: chocolate;">SFTP account will be removed on {{deletion_date}}.</span> If you need this account to be continued further, please inform Techops.</span>
                                            </p>
                                            <ul>
...
<!--[if (IE)]></div><![endif]-->
    ...
    email_body = email_body.replace('{{port}}', '2112')
    email_body = email_body.replace('{{deletion_date}}', sftp_deletion_date)
...
def send_deletion_email(sftp_account_object):
    sftp_user_name = sftp_account_object['username']
    receiver_email = sftp_account_object['requesterEmailAddress']
    sftp_hostname = sftp_account_object['serverIP']
    sftp_deletion_date = sftp_account_object['deletionDate']
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:50px; padding-bottom:5px; padding-right: 50px; padding-left: 50px;">
                                    ...
                                    <div class="desktop_hide"
                                        ...
                                        <div style="color:#66BECD;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:150%;padding-top:2px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <div style="line-height: 18px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color: #66BECD;">
                                                <p style="line-height: 36px; text-align: left; font-size: 12px; margin: 0;">
                                                    <span style="font-size: 24px;font-weight: bold;">SFTP Account Deleted - {{user_display_name}}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:0px; padding-bottom:5px; padding-right: 50px; padding-left: 50px;">
                                    ...
                                    <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 18px; color: #555555;">
                                            <p style="font-size: 12px; line-height: 24px; margin: 0;text-align: justify"><span
                                                    style="font-size: 16px;">Hi Team,<strong><br/></strong>Please be noted that the following <span
                                                    style="font-style: italic;font-weight: 600;color: chocolate;">SFTP account has been removed today.</span> If you need this account to be restored and continue further, please inform Techops.</span>
                                            </p>
                                            <ul>
                                                <li style="font-size: 12px; line-height: 18px;"><span
                                                        style="font-size: 16px; line-height: 24px;"><strong>Username</strong> : {{user_name}}</span>
